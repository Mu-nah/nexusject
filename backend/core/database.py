    ...
    try:
        payroll_column_map = {
            "employees": {
                ...
                "date_of_birth": "ALTER TABLE employees ADD COLUMN date_of_birth TIMESTAMP",
                ...
                "director_ni": "ALTER TABLE employees ADD COLUMN director_ni BOOLEAN DEFAULT FALSE",
                "student_loan_plan": "ALTER TABLE employees ADD COLUMN student_loan_plan VARCHAR(20)",
                "postgraduate_loan": "ALTER TABLE employees ADD COLUMN postgraduate_loan BOOLEAN DEFAULT FALSE",
                "starter_declaration": "ALTER TABLE employees ADD COLUMN starter_declaration VARCHAR(5)",
                "leaving_date": "ALTER TABLE employees ADD COLUMN leaving_date TIMESTAMP",
                ...
                "pension_postponement_date": "ALTER TABLE employees ADD COLUMN pension_postponement_date TIMESTAMP",
                "pension_enrolment_date": "ALTER TABLE employees ADD COLUMN pension_enrolment_date TIMESTAMP",
                "pension_opt_out_date": "ALTER TABLE employees ADD COLUMN pension_opt_out_date TIMESTAMP",
            },
            "payroll_runs": {
                ...
                "week_53": "ALTER TABLE payroll_runs ADD COLUMN week_53 BOOLEAN DEFAULT FALSE",
                ...
                "bacs_generated_at": "ALTER TABLE payroll_runs ADD COLUMN bacs_generated_at TIMESTAMP",
                "locked_at": "ALTER TABLE payroll_runs ADD COLUMN locked_at TIMESTAMP",
                "submitted_at": "ALTER TABLE payroll_runs ADD COLUMN submitted_at TIMESTAMP",
                "paid_at": "ALTER TABLE payroll_runs ADD COLUMN paid_at TIMESTAMP",
            },
            "payroll_records": {
