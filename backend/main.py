...
# Routers
from backend.routers import auth, accounting, expenses, payroll, grants, donations, dashboard, ai, admin, reports, planning, ops, platform
...
app.include_router(platform.employee_router)
